  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-6">
      <div className="max-w-md text-center">
        <p className="text-8xl font-extrabold tabular-nums tracking-tight text-[#DC2626]/20 sm:text-9xl">
          404
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 rounded-xl border border-[#DC2626]/40 bg-[#DC2626]/10 px-5 py-3 text-sm font-semibold text-[#DC2626] transition-all duration-200 hover:bg-[#DC2626]/15 hover:border-[#DC2626]/60 hover:shadow-glow-subtle focus:outline-none focus:ring-2 focus:ring-[#DC2626]/40 focus:ring-offset-2 focus:ring-offset-[hsl(var(--background))]"
          >
